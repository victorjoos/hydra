...
After a After many months and a lot of hard work by many people, Hydra 1.1 is finally out!  
Hydra 1.1 comes with OmegaConf 2.1, which has it's own share of awesome new features.

<!--truncate-->

This blog post highlights some of the most prominent changes, check the release notes to learn more:
...
`hydra.utils.instantiate()` now instantiate nested objects recursively.
...
If you see a change in behavior that is not mentioned in the release notes feel free reach out for help.
